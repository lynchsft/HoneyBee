...
func async2<A, B, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (B, ((Error?) -> Void)?) -> Void, on: Performer.Type, file: StaticString, line: UInt) -> DoubleArgFunction<A, B, Void, Performer> {
    DoubleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>, b: Link<B, Performer>) -> Link<Void, Performer> in
...
public func async2<A, B, R, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (B, @escaping (R) -> Void) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> DoubleArgFunction<A, B, R, Performer> {
    DoubleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>, b: Link<B, Performer>) -> Link<R, Performer> in
        (a+b).chain(file: file, line: line, functionDescription: tname(function)) { (unwrappedArgs: (a: A, b: B), completion: @escaping (R) -> Void) -> Void in
            try function(unwrappedArgs.a)(unwrappedArgs.b,completion)
        }
...
public func async1<A, R, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (((R) -> Void)?) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> SingleArgFunction<A, R, Performer> {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<R, Performer> in
        a.chain(file: file, line: line, functionDescription: tname(function), function)
    }
}
	
public func async1<A, R, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (@escaping (R) -> Void) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> SingleArgFunction<A, R, Performer> {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<R, Performer> in
        a.chain(file: file, line: line, functionDescription: tname(function), function)
    }
}
...
public func async3<A, B, C, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (B, C, (() -> Void)?) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> TripleArgFunction<A, B, C, Void, Performer> {
    TripleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>, b: Link<B, Performer>, c: Link<C, Performer>) -> Link<Void, Performer> in
        (a+b+c).chain(file: file, line: line, functionDescription: tname(function)) { (unwrappedArgs: (a: A, b: B, c: C), completion: @escaping () -> Void) -> Void in
            try function(unwrappedArgs.a)(unwrappedArgs.b, unwrappedArgs.c, completion)
        }.drop
...
public func async3<A, B, C, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (B, C, @escaping () -> Void) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> TripleArgFunction<A, B, C, Void, Performer> {
    TripleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>, b: Link<B, Performer>, c: Link<C, Performer>) -> Link<Void, Performer> in
        (a+b+c).chain(file: file, line: line, functionDescription: tname(function)) { (unwrappedArgs: (a: A, b: B, c: C), completion: @escaping () -> Void) -> Void in
            try function(unwrappedArgs.a)(unwrappedArgs.b, unwrappedArgs.c, completion)
        }.drop
...
public func async2<A, B, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (B, (() -> Void)?) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> DoubleArgFunction<A, B, Void, Performer> {
    DoubleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>, b: Link<B, Performer>) -> Link<Void, Performer> in
        (a+b).chain(file: file, line: line, functionDescription: tname(function)) { (unwrappedArgs: (a: A, b: B), completion: @escaping () -> Void) -> Void in
            try function(unwrappedArgs.a)(unwrappedArgs.b, completion)
        }.drop
...
public func async2<A, B, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (B, @escaping () -> Void) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> DoubleArgFunction<A, B, Void, Performer> {
    DoubleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>, b: Link<B, Performer>) -> Link<Void, Performer> in
        (a+b).chain(file: file, line: line, functionDescription: tname(function)) { (unwrappedArgs: (a: A, b: B), completion: @escaping () -> Void) -> Void in
            try function(unwrappedArgs.a)(unwrappedArgs.b, completion)
        }.drop
...
public func async1<A, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> ((() -> Void)?) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> SingleArgFunction<A, Void, Performer> {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<Void, Performer> in
        a.chain(file: file, line: line, functionDescription: tname(function), function).drop
    }
}
	
public func async1<A, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (@escaping () -> Void) throws -> Void, on: Performer.Type, file: StaticString, line: UInt) -> SingleArgFunction<A, Void, Performer> {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<Void, Performer> in
        a.chain(file: file, line: line, functionDescription: tname(function), function).drop
    }
}
...
public func async1<A, R, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (@escaping (R?, Error?) -> Void) -> Void, on: Performer.Type, file: StaticString = #file, line: UInt = #line) -> SingleArgFunction<A, R, Performer>  {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<R, Performer> in
...
public func async1<A, E: Error, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (((E?) -> Void)?) -> Void, on: Performer.Type, file: StaticString = #file, line: UInt = #line) -> SingleArgFunction<A,Void, Performer>  {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<Void, Performer> in
...
public func async1<A, E: Error, Performer: AsyncBlockPerformer>(_ function: @escaping (A) -> (@escaping (E?) -> Void) -> Void, on: Performer.Type, file: StaticString = #file, line: UInt = #line) -> SingleArgFunction<A,Void, Performer>  {
    SingleArgFunction(action: tname(function), file: file, line: line) { (a: Link<A, Performer>) -> Link<Void, Performer> in
        a.chain(file: file, line: line, functionDescription: tname(function)) { (a: A, completion: @escaping (Error?) -> Void) in
            function(a)(completion)
        }.drop
